      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-sm md:text-base text-foreground/75 dark:text-foreground/60 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="glass-card rounded-2xl p-8 flex gap-5">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-foreground/75 dark:text-foreground/60">
          ...
          {timeline.map((item, idx) => (
            ...
            >
              ...
              <div className="glass-card rounded-2xl p-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-foreground/75 dark:text-foreground/60">
                  {item.desc}
                </p>
              </div>
            </motion.div>
