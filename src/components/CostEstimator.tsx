...
export function CostEstimator() {
  ...
  useEffect(() => {
    ...
    let base = activePkg.basePerGuest * guestCount * activeEvent.multiplier;
    ...
    setTotalCost(Math.round(base + addonsTotal));
  }, [eventType, guestCount, selectedPackage, selectedAddons]);
