...
export function CalendarChecker() {
  ...
  // Generate deterministic "booked" days based on the month/year to mimic availability
  useEffect(() => {
            ...
            return (
              <button
                ...
                className={`py-3 text-xs font-medium rounded-xl flex flex-col items-center justify-center relative transition-all ${
                  booked
                    ? 'bg-zinc-100 text-zinc-300 dark:bg-zinc-800/20 dark:text-zinc-700 cursor-not-allowed'
                    : selected
